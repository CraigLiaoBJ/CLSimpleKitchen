...
@interface CLNewHeadReusableView (){
...
@implementation CLNewHeadReusableView
...
#pragma mark -- 布局
- (void)layoutSubviews{
    _fullImageView.frame = CGRectMake(10, 5, kWW - 20, 200);
    
    _contentLabel.frame = CGRectMake(10, 210, kWW -20, 90);
    _contentLabel.font = [UIFont systemFontOfSize:13];

    _moreBtn.frame = CGRectMake(kWW / 8 * 7.5, 280, 20, 20);
...
- (void)setHeadItem:(CLModelItem *)headItem{
    ...
    _contentLabel.text = headItem.content;
