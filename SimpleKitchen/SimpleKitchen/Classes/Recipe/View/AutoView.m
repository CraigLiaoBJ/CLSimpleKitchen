...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self){
        ...
        _imageScrollView.contentSize = CGSizeMake(kAutoViewWidth * 10, kAutoViewHeight);
...
+ (id)imageScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSArray *)imageLinkURL pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle{
    AutoView *autoView = [AutoView imageScrollViewWithFrame:frame imageLinkURL:imageLinkURL placeHolderImageName:nil pageControlShowStyle:PageControlShowStyle];
    return autoView;
}

+ (id)imageScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSArray *)imageLinkURL placeHolderImageName:(NSString *)imageName pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle{
